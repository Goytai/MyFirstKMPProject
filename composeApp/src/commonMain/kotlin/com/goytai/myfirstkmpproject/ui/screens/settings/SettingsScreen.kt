...
class SettingsScreen : Screen {
    ...
    override fun Content() {
        val screenModel = rememberScreenModel<SettingsScreenModelParams, SettingsScreenModel>(
            arg = SettingsScreenModelParams(navigator = LocalNavigator.currentOrThrow)
        )
